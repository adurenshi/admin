...
<div class="content">
        <div class="header">
              <h1 class="page-title"><i class="glyphicon glyphicon-th-list"></i> 报告列表</h1> 
        </div>
   <div class="main-content">
	 <div class="panel panel-default">
        <label class="panel-heading" data-toggle="collapse"><font size="3"> 搜索日报</font></label> 
        <div id="page-stats" class="panel-collapse panel-body collapse in">

            <form class="form-inline">
            <div class="form-row">
             <div class="form-group">
                    <label  for="exampleInputEmail3">提交人:</label>
                    <input type="text" class="input-sm form-control" id="exampleInputEmail3" placeholder="输入姓名">
                  </div> <span class="space"></span>
            <div class="form-group">
                <label for="exampleInputName2">日报类型:</label>
              ...
              <div class="form-group">
                    <label  for="exampleInputEmail3">提交日期范围:</label>
              ...
              <div class="form-row">
                  <div class="form-group">
                    <label  for="exampleInputEmail3">接收人:</label>
                    <input type="text" class="input-sm form-control" id="exampleInputEmail3" placeholder="输入姓名">
                  </div><span class="space"></span>
...
<input type="hidden" value="reportlist.php" id="currenturl">
