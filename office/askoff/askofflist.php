...
<div class="content">
        <div class="header">
              <h1 class="page-title"><i class="glyphicon glyphicon-th-list"></i> 请假列表</h1> 
        </div>
   <div class="main-content">
	 <div class="panel panel-default">
        <label class="panel-heading" data-toggle="collapse"><font size="3"> 搜索请假记录</font></label> 
        <div id="page-stats" class="panel-collapse panel-body collapse in">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                    <label  for="exampleInputEmail3">请假日期范围:</label>
              ...
              <div class="form-row">
                ...
                <div class="form-group">
                    <label  for="exampleInputEmail3">请假申请关键词:</label>
...
<input type="hidden" value="askofflist.php" id="currenturl">
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        $("#askforview").click(function(){
            window.location.href='askoffview.php';
        });
    } );
</script>
