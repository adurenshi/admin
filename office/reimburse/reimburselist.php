...
<div class="content">
        <div class="header">
              <h1 class="page-title"><i class="glyphicon glyphicon-th-list"></i> 报销列表</h1> 
        </div>
   <div class="main-content">
	 <div class="panel panel-default">
        <label class="panel-heading" data-toggle="collapse"><font size="3"> 搜索报销</font></label> 
        <div id="page-stats" class="panel-collapse panel-body collapse in">
            ...
            <div class="form-row">
              ...
              <div class="form-row">
                  <div class="form-group">
                    <label  for="exampleInputEmail3">审批人:</label>
                    <input type="text" class="input-sm form-control" id="exampleInputEmail3" placeholder="输入姓名">
                  </div><span class="space"></span>
                   <div class="form-group">
                    <label  for="exampleInputEmail3">主题关键文字:</label>
                    <input type="text" class="input-sm form-control" id="exampleInputEmail3" placeholder="标题关键词">
                  </div>
         ...
         <div class="panel panel-default">
            <label class="panel-heading" data-toggle="collapse"><font size="3"> 报销列表</font></label> 
            <div id="page-stats" class="panel-collapse panel-body collapse in">
...
<input type="hidden" value="reimburselist.php" id="currenturl">
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        $("#askforview").click(function(){
            window.location.href='reimburseview.php';
        });
    } );
</script>
